...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
     * | LCTRL  | LGUI   | LALT   | _ACC   | _FN    | _NAV   | BKSP   | LALT   | ENTER  | SPACE  | _FN    | ALT_GR | LEFT   | DOWN   | RIGHT  |
     * '--------------------------------------------------------------------------------------------------------------------------------------'
     */
    [_CO] = LAYOUT_ortho_5x15( /* COLEMAK */
        ...
        LS__PRN,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_HOME,   KC_UP,  KC_END,    KC_K,    KC_M, KC_COMM,  KC_DOT,   KC_UP, RS__PRN,
        LC__CBR, KC_LGUI, KC_LALT,  KL_ACC,   KL_FN,  KL_NAV, KC_BSPC, KC_LALT,  KC_ENT,  KC_SPC,   KL_FN, KC_ALGR, KC_LEFT, KC_DOWN, KC_RIGHT
    ),
     ...
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
     * |        | A_GRAV | RGSTR  | XXXXXX | U_GRAV | DEGREE |        |        |        | XXXXXX | E_AIGU | E_GRAV | I_GRAV | O_GRAV | Play   |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
    ...
    [_ACCENT] = LAYOUT_ortho_5x15(
        ...
        _______,  A_GRAV, K_RGSTR, XXXXXXX, U_GRAV , K_DEGRE, _______, _______, _______, XXXXXXX,  E_AIGU,  E_GRAV,  I_GRAV,  O_GRAV, KC_MPLY,
     ...
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
     * |        | _      | !      | =      | (      | XXXXXX |        |        |        | XXXXXX | )      | =      | +      | -      | Play   |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
     * |        | XXXXXX | XXXXXX | XXXXXX | [      | XXXXXX |        |        |        | XXXXXX | ]      | _      | Play   | VOL+   | XXXXXX |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
     * |        |        |        |        |        |        |        |        |        |        |        |        | PREV   | VOL-   | NEXT   |
     * '--------------------------------------------------------------------------------------------------------------------------------------'
     */
    [_FN] = LAYOUT_ortho_5x15( /* FUNCTION */
        ...
        _______, K_UNDER,  K_EXCL,   K_EQL,  K_LPRN, XXXXXXX, _______, _______, _______, XXXXXXX,  K_RPRN,   K_EQL,  K_PLUS,  K_MINS, KC_MPLY,
        _______, XXXXXXX, XXXXXXX, XXXXXXX,   K_LBR, XXXXXXX, _______, _______, _______, XXXXXXX,   K_RBR, K_UNDER, KC_MPLY, KC_VOLU, XXXXXXX,
